...
const gallery_content = [
  {
    ...
    text2:
      "We provide our clients with a wide range of assistance in their daily chores ranging from cleaning to cooking",
  },
  {
    id: 2,
    ...
    text1: "NURSING ",
    text2:
      "AnaesFor clients needing special care we provide home nursing services through our qualified staff.These may include but are not limited to Aged care, Post-Operative care, Rehabilitation support, Dementia and Parkisnson's disease etcthetist",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    text2:
      "For clients needing special behavioral  support we offer therapy services ranging from psychological help in phases of anxiety, depression and other disorders to help them thrive socially",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    text1: "PERSONAL CARE",
    text2:
      "Our competent staff are well trained to provide personal care to our clients so their hygiene and health are never compromised ",
  },
  {
    id: 8,
